...
function formatPayload(payload) {
  ...
  if (payload.via) parts.push(`Via: ${payload.via.replace('_', ' ')}`);
    ...
    <div className="agp-root">
      <header className="agp-page-header">
        ...
        <div className="agp-header-stats">
          <div className="agp-stat">
            ...
            <span className="agp-stat-label">Events shown</span>
          </div>
        </div>
      </header>
      ...
      <div className="agp-context-bar">
        <p className="agp-workflow-hint">
          Superuser actions, admin user requests, and company owner approvals are recorded here.
        </p>
      </div>
