...
const GLMapping = () => {
    ...
    return (
      <div className="glm-root">
        <div className="glm-error">
          <p>{error}</p>
          <button type="button" onClick={fetchData} className="glm-btn glm-btn--primary">Retry</button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="glm-root">
      <header className="glm-rail">
        <div>
          <p className="glm-rail__eyebrow">Accounting</p>
          <h1 className="glm-rail__title">GL Mapping</h1>
          <p className="glm-rail__blurb">
            View and manage bank and investment General Ledger account mappings.
          </p>
        </div>
      </header>

      <nav className="glm-tabs" aria-label="GL mapping views">
        <button
          type="button"
        ...
        {activeTab === 'bank' && (
          <div className="glm-tab-content">
            <div className="glm-section-header">
              ...
              <button type="button" onClick={fetchData} className="glm-btn glm-btn--secondary">
            ...
            <div className="glm-search-bar">
              <svg className="glm-search-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
