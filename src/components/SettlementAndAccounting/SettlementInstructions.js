...
const SettlementInstructions = () => {
    ...
    return (
      <div className="si-root">
        <div className="si-error">
          <p>{error}</p>
          <button type="button" onClick={fetchData} className="si-btn si-btn-primary">Retry</button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="si-root">
      <header className="si-rail">
        <div>
          <p className="si-rail__eyebrow">Accounting</p>
          <h1 className="si-rail__title">Settlement Instructions</h1>
          <p className="si-rail__blurb">
            Configure default settlement accounts, portfolio mappings, and preferences.
          </p>
        </div>
      </header>

      <nav className="si-tabs" aria-label="Settlement instruction views">
        <button
          type="button"
